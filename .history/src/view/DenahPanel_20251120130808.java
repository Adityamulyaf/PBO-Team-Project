...
public class DenahPanel extends JPanel {
    ...
    public DenahPanel(String role) {
        ...
        ruanganList.add(new RoomData("hh", tempX, currentY + 48 + roomGap, 45, 48, false, "Non-Peminjaman")); 
        ruanganList.add(new RoomData("", tempX, currentY + 96 + roomGap * 2, 45, baseRoomHeight + roomGap, false, "Non-Peminjaman"));
        
        tempX += 45 + roomGap;
        
        // Blok Abu-abu Kanan Kecil (Non-Peminjaman)
        ruanganList.add(new RoomData("ff", tempX, currentY, 45, baseRoomHeight + roomGap, false, "Non-Peminjaman")); 
        ruanganList.add(new RoomData("", tempX, currentY + baseRoomHeight + roomGap * 2, 45, baseRoomHeight, false, "Non-Peminjaman"));
